[Skip to main content](https://docs.pact.io/pact_broker/kubernetes/readme#__docusaurus_skipToContent_fallback)

🚀 AI Automation is Here! Simplify Contract Testing with PactFlow. [Sign Up Now >>](https://pactflow.io/ai/?utm_source=docs.pact.io&utm_medium=web&utm_campaign=ai-beta&utm_content=banner).

[![Docusaurus Logo](https://docs.pact.io/img/favicon.ico)\\
**Pact**](https://docs.pact.io/) [Getting Started](https://docs.pact.io/) [Guides](https://docs.pact.io/consumer) [Pact Docs](https://docs.pact.io/implementation_guides/overview) [Pact Broker Docs](https://docs.pact.io/pact_broker) [Resources](https://docs.pact.io/history) [Contributing](https://docs.pact.io/contributing) [Blog](https://docs.pact.io/blog) [Help](https://docs.pact.io/help) [University](https://docs.pact.io/university)

Search`Ctrl`  `K`

- [Pact Broker](https://docs.pact.io/pact_broker/kubernetes/readme#)

- [Pact Broker Client CLI](https://docs.pact.io/pact_broker/kubernetes/readme#)

- [Pact Broker - Docker](https://docs.pact.io/pact_broker/kubernetes/readme#)

- [Pact Broker - Kubernetes](https://docs.pact.io/pact_broker/kubernetes/readme#)

  - [Overview](https://docs.pact.io/pact_broker/kubernetes)
  - [Deploy with Helm](https://docs.pact.io/pact_broker/kubernetes/readme)
...
## TL;DR [​](https://docs.pact.io/pact_broker/kubernetes/readme\#tldr "Direct link to TL;DR")
...
## Usage [​](https://docs.pact.io/pact_broker/kubernetes/readme\#usage "Direct link to Usage")
...
### Installing from Chart Repository [​](https://docs.pact.io/pact_broker/kubernetes/readme\#installing-from-chart-repository "Direct link to Installing from Chart Repository")
...
### Installing from an OCI Registry [​](https://docs.pact.io/pact_broker/kubernetes/readme\#installing-from-an-oci-registry "Direct link to Installing from an OCI Registry")
...
## Source Code [​](https://docs.pact.io/pact_broker/kubernetes/readme\#source-code "Direct link to Source Code")

- [pact\_broker](https://github.com/pact-foundation/pact_broker)

## Requirements [​](https://docs.pact.io/pact_broker/kubernetes/readme\#requirements "Direct link to Requirements")

| Repository | Name | Version |
| --- | --- | --- |
| [https://charts.bitnami.com/bitnami](https://charts.bitnami.com/bitnami) | common | 1.x.x |
| [https://charts.bitnami.com/bitnami](https://charts.bitnami.com/bitnami) | postgresql | 11.x.x |

## Values [​](https://docs.pact.io/pact_broker/kubernetes/readme\#values "Direct link to Values")
...
| broker.config.autoDetectMainBranch | When true and a pacticipant version is created with a tag or a branch that matches one of the names in main\_branch\_candidates, the mainBranch property is set for that pacticipant if it is not already set. | bool | `true` |
...
| broker.config.disable\_ssl | If set to true, SSL verification will be disabled for the HTTP requests made by the webhooks | bool | `false` |
...
| broker.config.httpDebugLoggingEnabled | Enable this setting to print the entire request and response to the logs at debug level. Do not leave this on permanently, as it will have performance and security issues. Ensure the application log\_level is set to debug when this setting is enabled. | bool | `false` |
...
| broker.config.metricsSqlStatementTimeout | The number of seconds after which the SQL queries used for the metrics endpoint will be aborted. This is configurable separately from the standard database\_statement\_timeout as it may need to be significantly longer than the desired value for standard queries. | int | `30` |
...
| broker.config.useFirstTagAsBranch | When true, the first tag applied to a version within the use\_first\_tag\_as\_branch\_time\_limit (10 seconds) will be used to populate the branch property of the version. | bool | `true` |
...
| broker.config.webhookHttpCodeSuccess | If webhook call returns the response with an HTTP code that is listed in the success codes then the operation is considered a success, otherwise the webhook will be re-triggered based on the webhook\_retry\_schedule configuration. | string | `"200 201 202 203 204 205 206"` |
...
## Configuration and Installation Details [​](https://docs.pact.io/pact_broker/kubernetes/readme\#configuration-and-installation-details "Direct link to Configuration and Installation Details")

### Configuring Chart PostgreSQL [​](https://docs.pact.io/pact_broker/kubernetes/readme\#configuring-chart-postgresql "Direct link to Configuring Chart PostgreSQL")
...
#### Automatic Database Credential Creation [​](https://docs.pact.io/pact_broker/kubernetes/readme\#automatic-database-credential-creation "Direct link to Automatic Database Credential Creation")
...
#### Specifying Password for PostgreSQL to Use [​](https://docs.pact.io/pact_broker/kubernetes/readme\#specifying-password-for-postgresql-to-use "Direct link to Specifying Password for PostgreSQL to Use")
...
#### Specifying Existing Secret for PostgreSQL to Use [​](https://docs.pact.io/pact_broker/kubernetes/readme\#specifying-existing-secret-for-postgresql-to-use "Direct link to Specifying Existing Secret for PostgreSQL to Use")
...
### Configuring External Database [​](https://docs.pact.io/pact_broker/kubernetes/readme\#configuring-external-database "Direct link to Configuring External Database")
...
#### Specify Credentials via Values [​](https://docs.pact.io/pact_broker/kubernetes/readme\#specify-credentials-via-values "Direct link to Specify Credentials via Values")
...
#### Specify Credentials via Secret [​](https://docs.pact.io/pact_broker/kubernetes/readme\#specify-credentials-via-secret "Direct link to Specify Credentials via Secret")
...
### Database Clean Task [​](https://docs.pact.io/pact_broker/kubernetes/readme\#database-clean-task "Direct link to Database Clean Task")
...
[Edit this page](https://github.com/pact-foundation/pact-broker-chart/edit/master/charts/pact-broker/README.md)

Last updated on **Mar 27, 2026** by **Kevin Rohan Vaz**

[Previous\\
\\
Overview](https://docs.pact.io/pact_broker/kubernetes)

- [TL;DR](https://docs.pact.io/pact_broker/kubernetes/readme#tldr)
- [Usage](https://docs.pact.io/pact_broker/kubernetes/readme#usage)
  - [Installing from Chart Repository](https://docs.pact.io/pact_broker/kubernetes/readme#installing-from-chart-repository)
  - [Installing from an OCI Registry](https://docs.pact.io/pact_broker/kubernetes/readme#installing-from-an-oci-registry)
- [Source Code](https://docs.pact.io/pact_broker/kubernetes/readme#source-code)
- [Requirements](https://docs.pact.io/pact_broker/kubernetes/readme#requirements)
- [Values](https://docs.pact.io/pact_broker/kubernetes/readme#values)
- [Configuration and Installation Details](https://docs.pact.io/pact_broker/kubernetes/readme#configuration-and-installation-details)
  - [Configuring Chart PostgreSQL](https://docs.pact.io/pact_broker/kubernetes/readme#configuring-chart-postgresql)
  - [Configuring External Database](https://docs.pact.io/pact_broker/kubernetes/readme#configuring-external-database)
  - [Database Clean Task](https://docs.pact.io/pact_broker/kubernetes/readme#database-clean-task)

Is this page useful?

#### Docs

- [Getting Started](https://docs.pact.io/)
- [Guides](https://docs.pact.io/consumer)
- [Pact Docs](https://docs.pact.io/implementation_guides/cli)
- [Resources](https://docs.pact.io/history)
- [Help](https://docs.pact.io/help)
...
[![Pact Foundation logo](https://docs.pact.io/img/favicon.ico)](https://docs.pact.io/)

Copyright © 2026 Pact Foundation

![](https://static.scarf.sh/a.png?x-pxid=4eb08b9f-98b1-4f94-9f0b-47f793362c8a)