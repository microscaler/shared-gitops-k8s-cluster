...
| 3 Migrate stacks | **in progress** | Enabled: `namespaces`, `cluster`, `cylon-infra`, `platform-dev-tls`, `postgres-ha` (Bitnami + bitnamilegacy). Remaining: platform-data (redis/minio/…), observability, ai, openbao |
